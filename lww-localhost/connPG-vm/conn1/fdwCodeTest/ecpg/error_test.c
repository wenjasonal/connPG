...
#line 22 "error_test.pgc"
 //multi-test 
    ...
    { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "insert into organ ( organcode , organname ) values ( $1  , $2  )", 
	ECPGt_int,&(caID[0]),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_char,(caName[0]),(long)30 + 1,(long)1,(30 + 1)*sizeof(char), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EOIT, ECPGt_EORT);}
#line 30 "error_test.pgc"
...
#line 60 "error_test.pgc"

        { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "delete from organ where organcode = 100", ECPGt_EOIT, ECPGt_EORT);}
#line 61 "error_test.pgc"

        { ECPGtrans(__LINE__, NULL, "commit");}
#line 62 "error_test.pgc"

	
     { ECPGtrans(__LINE__, NULL, "begin transaction");}
#line 64 "error_test.pgc"
 
	ECPGset_var( 0, ( caName ), __LINE__);\
 ECPGset_var( 1, ( caID ), __LINE__);\
 /* declare tb_cur cursor for select organcode , organname from organ */
#line 66 "error_test.pgc"
