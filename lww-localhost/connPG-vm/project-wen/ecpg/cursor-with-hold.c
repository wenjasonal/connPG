...
#line 8 "cursor-with-hold.pgc"
 int caCode [ 10 ] ;
 
#line 9 "cursor-with-hold.pgc"
...
#line 63 "cursor-with-hold.pgc"

     //EXEC SQL COMMIT;
   }     

  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "close organ_cursor", ECPGt_EOIT, ECPGt_EORT);}
#line 67 "cursor-with-hold.pgc"

  { ECPGtrans(__LINE__, NULL, "commit");}
#line 68 "cursor-with-hold.pgc"



  { ECPGdisconnect(__LINE__, "ALL");}
#line 71 "cursor-with-hold.pgc"
