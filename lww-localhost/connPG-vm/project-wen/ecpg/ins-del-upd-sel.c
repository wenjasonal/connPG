...
#line 10 "ins-del-upd-sel.pgc"
  ...
  { ECPGconnect(__LINE__, 0, "test@10.136.1.143:5432" , "lww" , "lww" , "myconn", 0); }
...
#line 39 "ins-del-upd-sel.pgc"
  ...
  //插入记录
  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "insert into organ values ( 1 , '机构' )", ECPGt_EOIT, ECPGt_EORT);}
#line 42 "ins-del-upd-sel.pgc"
 
  //EXEC SQL INSERT INTO organ values (111, 'psbc'); 
  { ECPGtrans(__LINE__, NULL, "commit");}
#line 44 "ins-del-upd-sel.pgc"
 //ecpg编译时不加-t参数，此处需要显示提交,否则数据库内数据未更新！若此处未写后续只要出现commit均可提交成功！
  ...
  //读取插入的单条记录
  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select organcode , organname from organ", ECPGt_EOIT, 
	ECPGt_int,&(caCode),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
	ECPGt_varchar,&(caName),(long)30,(long)1,sizeof(struct varchar_1), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, ECPGt_EORT);}
#line 54 "ins-del-upd-sel.pgc"

  printf("insert one record:\n organcode = %d, organname = %*s\n", caCode, caName.len, caName.arr); //NOTE: varchar type

  sleep (5); //just test

  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "update organ set organname = '机构更名'", ECPGt_EOIT, ECPGt_EORT);}
#line 59 "ins-del-upd-sel.pgc"

  //EXEC SQL UPDATE organ SET organname = 'psbc rename';
  { ECPGtrans(__LINE__, NULL, "commit");}
#line 61 "ins-del-upd-sel.pgc"
...
#line 63 "ins-del-upd-sel.pgc"
  ...
  //删除表内记录
  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "delete from organ", ECPGt_EOIT, ECPGt_EORT);}
#line 69 "ins-del-upd-sel.pgc"

  { ECPGtrans(__LINE__, NULL, "commit");}
#line 70 "ins-del-upd-sel.pgc"
 ...
 */
  ...
  caCode= 0;
 // caName.len=0;
  memset(caName.arr, 0x00,sizeof(caName.len));
  //验证是否删除
  { ECPGdo(__LINE__, 0, 1, NULL, 0, ECPGst_normal, "select organcode , organname from organ", ECPGt_EOIT, 
	ECPGt_int,&(caCode),(long)1,(long)1,sizeof(int), 
	ECPGt_NO_INDICATOR, NULL , 0L, 0L, 0L, 
