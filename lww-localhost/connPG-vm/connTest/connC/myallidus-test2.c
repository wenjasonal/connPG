...
int main(int argc, char **argv)
{
   ...
   if (argc > 1)
      ...
      conninfo = "host=10.136.2.45 port=30001 user=lww password=lww dbname=mytestdb";
  ...
  // PQexec(conn, "drop table test2");//multi-test!! first run this program it must be inactived.
